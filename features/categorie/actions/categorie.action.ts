...
import {
  ICategory,
  ICategoryAddUpdateResponse,
  ICategoryDeleteResponse,
  ICategoryParams,
} from "../types/categorie.type";

export const obtenirTousCategoryAction = async (
...
export const obtenirUnCategoryAction = async (
  id: string,
): Promise<ActionResponse<ICategory>> => {
  try {
    ...
    return handleServerActionError(
      error,
      "Erreur lors de la récupération de la Category",
    );
  }
};

export const ajouterCategoryAction = async (
  formdata: CreateCategoryDTO,
): Promise<ActionResponse<ICategoryAddUpdateResponse>> => {
  try {
...
export const modifierCategoryAction = async (
  id: string,
  formdata: UpdatePropertyCategoryDTO,
): Promise<ActionResponse<ICategoryAddUpdateResponse>> => {
  try {
...
export const supprimerCategoryAction = async (
  id: string,
): Promise<ActionResponse<ICategoryDeleteResponse>> => {
  try {
